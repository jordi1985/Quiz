...
import static edu.upc.eseiaat.pma.quiz.R.id.btn_check;
...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_question.setText(R.string.question_conten);
        ...
        final RadioGroup group = (RadioGroup) findViewById(R.id.answers_group);
       ...
       btn_check.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               Log.i("clicat", String.format("Id: %d", id));
